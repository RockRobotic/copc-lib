...
def read_concat_xyz_class_limit(
    ...
    """
    assert isinstance(classification_limits, list) or classification_limits is None, f"Argument 'classification_limits' is of invalid type! {classification_limits}"
