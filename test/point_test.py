...
#     ss = BytesIO()
#     orig_point = copclib.Point(0, 2)  # use two extra bytes
#     orig_point.X(20)
#     orig_point.Y(-20)
#     orig_point.Z(100000)
...
#     point = orig_point
#     point.Pack(ss)
#     point_other = copclib.Point.Unpack(ss, 0, point.NumExtraBytes())
#     assert point == point_other
#
#     # Format 1
#     point.ToPointFormat(1)
#     point.Pack(ss)
#     point_other = copclib.Point.Unpack(ss, 1, point.NumExtraBytes())
#     assert point == point_other
#
#     # Format 2
#     point.ToPointFormat(2)
#     point.Pack(ss)
#     point_other = copclib.Point.Unpack(ss, 2, point.NumExtraBytes())
#     assert point == point_other
#
#     # Format 3
#     point.ToPointFormat(3)
#     point.Pack(ss)
#     point_other = copclib.Point.Unpack(ss, 3, point.NumExtraBytes())
#     assert point == point_other
#
#     # Format 6
#     point.ToPointFormat(6)
#     point.Pack(ss)
#     point_other = copclib.Point.Unpack(ss, 6, point.NumExtraBytes())
#     assert point == point_other
#
#     # Format 7
#     point.ToPointFormat(7)
#     point.Pack(ss)
#     point_other = copclib.Point.Unpack(ss, 7, point.NumExtraBytes())
#     assert point == point_other
#
#     # Format 8
#     point.ToPointFormat(8)
#     point.Pack(ss)
#     point_other = copclib.Point.Unpack(ss, 8, point.NumExtraBytes())
#     assert point == point_other
#
#     point.ToPointFormat(0)
#     assert point == orig_point
