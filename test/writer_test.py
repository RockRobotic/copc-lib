...
def test_writer_config():
    ...
    assert reader.copc_config.las_header.scale == reader.copc_config.las_header.scale
    assert reader.copc_config.las_header.offset == reader.copc_config.las_header.offset
