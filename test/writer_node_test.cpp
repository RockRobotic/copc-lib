...
//            REQUIRE(sub_node.IsValid());
//            auto sub_node_data = reader.GetPointData(sub_node);
//            REQUIRE(sub_node_data == std::vector<char>(twenty_pts_prdf3, twenty_pts_prdf3 +
//            sizeof(twenty_pts_prdf3)));
//        }
//
//        {
//            auto sub_node = reader.FindNode(VoxelKey(1, 1, 1, 1));
//            REQUIRE(sub_node.IsValid());
//            auto sub_node_data = reader.GetPointData(sub_node);
//            REQUIRE(sub_node_data == std::vector<char>(twelve_pts_prdf3, twelve_pts_prdf3 +
//            sizeof(twelve_pts_prdf3)));
//        }
//
//        {
